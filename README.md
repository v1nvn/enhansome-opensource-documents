# Awesome Open Source Documents with stars
...
* [FreeBSD 从入门到跑路](origin/repo-freebsdask-book-cn) ([Site][site-freebsdask-book-cn], cc-by) - 这是一本 FreeBSD 操作系统书籍，还包含一些 OpenBSD、NetBSD、DragonFly BSD、TwinCAT/BSD 等 BSD 家族操作系统的快速入门章节
